...
function Inputs({ setQuery, units, setUnits }) {
  ...
  const handleLocationClick = () => {
    console.log("navigate in", navigator)
  ...
  return (
    <div className='flex flex-row justify-center my-6'>
      <div className='flex flex-row w-3/4 items-center justify-center space-x-4'>
        <input value={city} onChange={(e) => setCity(e.target.value)} type='text' className='text-xl font-light p-2 w-full shadow-xl capitalize outline-none placeholder:lowercase' placeholder='Search for city...' />
      ...
      <div className='flex flex-row w-1/4 items-center justify-center'>
        <button onClick={handleUnitsChange} name='matric' className='text-xl text-white font-light transition ease-out hover:scale-125'>°C</button>
